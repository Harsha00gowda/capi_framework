...
public class DeleteRechargeTest extends BaseTest {
	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void deleteRecharge(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a priority and click on delete icon
				page = rechargeListPage.searchAndDeleteRecharge(table.get("Resource Code"));
				if (page instanceof RechargeListPage){
					reportFailure("Unable to search and delete the specified recharge");
				}
				
				test.log(LogStatus.PASS, "Able to search and delete the specified recharge");
