...
public class DeletePriorityTest extends BaseTest {
	...
	public void deletePriority(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a priority and click on delete icon
				page = prioritiesListPage.searchAndDeletePriority(table.get("Priority"));
				if (page instanceof PrioritiesListPage){
					reportFailure("Unable to search and delete the specified priority");
				}
				
				test.log(LogStatus.PASS, "Able to search and delete the specified priority");
