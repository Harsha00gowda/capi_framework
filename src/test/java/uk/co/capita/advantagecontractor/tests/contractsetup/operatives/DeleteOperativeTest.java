...
public class DeleteOperativeTest extends BaseTest {
	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void deleteOperative(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for an operative and click on delete icon
				page = operativesListPage.searchAndDeleteOperative(table.get("Operative Code"));
				if (page instanceof OperativesListPage){
					reportFailure("Unable to search and delete the specified Operative");
				}
				
				test.log(LogStatus.PASS, "Able to search and delete the specified Operative");
