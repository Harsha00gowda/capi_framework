...
public class EditSystemOptionsTest extends BaseTest{

	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void editSystemOptions(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a System Option and click on edit icon
				page = systemOptionsListPage.searchAndClickOnEdit(table.get("Option"));
				if (page instanceof SystemOptionsListPage){
					reportFailure("Unable to search for the System Option and click on edit button");
				}
				
				test.log(LogStatus.INFO, "Able to search for the System Option and click on edit button");
				EditSystemOptionsPage editSystemOptionsPage = (EditSystemOptionsPage)page;
				
				//Editing the contract
				page = editSystemOptionsPage.editSystemOptionDetailsAndUpdate(table.get("Description"));
				if (page instanceof EditSystemOptionsPage){
					reportFailure("Unable to edit the system option");
				}
				
				test.log(LogStatus.PASS, "Specified system option was successfully edited");
