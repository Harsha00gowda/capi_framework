...
public class DeleteDiaryTest extends BaseTest {
	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void deleteDiary(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a Diary and click on delete icon
				page = diaryListPage.searchAndDeleteDiary(table.get("Diary Text"));
				if (page instanceof DiaryListPage){
					reportFailure("Unable to search and delete the specified diary");
				}
				
				test.log(LogStatus.PASS, "Able to search and delete the specified diary");
