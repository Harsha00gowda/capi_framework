...
public class CreateOperativeTradesForAContractTest extends BaseTest{

	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void createOperativeTradeForAContract(Hashtable<String, String> table) throws InterruptedException{
		...
		//Add trade for created contractor operative
		page = operativesListPage.goToAddOperativeTradePage();
		if (page instanceof OperativesListPage){
			reportFailure("Unable to go to Create Operative Trade page");
		}
		test.log(LogStatus.INFO, "Able to to go to Create Operative Trade page");
		AddOperativeTradePage addOperativeTradePage = (AddOperativeTradePage)page;

		//Add Operative Trade details
		page = addOperativeTradePage.addOperativeTradeDetailsAndSave();
		if (page instanceof AddOperativeTradePage){
			reportFailure("Unable to add Operative Trade details");
		}
		test.log(LogStatus.INFO, "Able to add Operative Trade details");
