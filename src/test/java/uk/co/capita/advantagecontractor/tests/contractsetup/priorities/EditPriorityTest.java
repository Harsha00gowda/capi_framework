...
public class EditPriorityTest extends BaseTest{

	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void editPriority(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a Priority and click on edit icon
				page = prioritiesListPage.searchAndClickOnEdit(table.get("Priority"));
				if (page instanceof PrioritiesListPage){
					reportFailure("Unable to search for the priority and click on edit button");
				}
				
				test.log(LogStatus.INFO, "Able to search for the contract and click on edit button");
				EditPriorityPage editPriorityPage = (EditPriorityPage)page;
				
				//Editing the contract
				page = editPriorityPage.editPriorityDetailsAndUpdate(table.get("Description"));
