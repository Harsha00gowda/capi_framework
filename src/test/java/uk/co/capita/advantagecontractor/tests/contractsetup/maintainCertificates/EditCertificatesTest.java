...
public class EditCertificatesTest extends BaseTest{

	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void editCertificates(Hashtable<String, String> table) throws InterruptedException{
		...
		//edit the available certificate
				page = certificatesListPage.searchAndClickOnEdit();
				if (page instanceof MaintainCertificatesListPage){
					reportFailure("Unable to search for the certificates and click on edit button");
				}
				
				test.log(LogStatus.INFO, "Able to search for the certificate and click on edit button");
