...
public class DeleteCertificateTest extends BaseTest {
	...
	public void deleteCertificate(Hashtable<String, String> table) throws InterruptedException{
		...
		//select certificate and click on delete icon
				page = certificatesListPage.deleteSelectedCertificate();
				if (page instanceof MaintainCertificatesListPage){
					reportFailure("Unable to delete the specified certificate");
				}
				test.log(LogStatus.PASS, "Able to delete the specified certificate");
