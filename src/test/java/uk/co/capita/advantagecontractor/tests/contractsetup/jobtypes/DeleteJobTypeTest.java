...
public class DeleteJobTypeTest extends BaseTest {
	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void deleteJobType(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a job type and click on delete icon
				page = jobTypesListPage.searchAndDeleteJobType(table.get("Job Type"));
				if (page instanceof JobTypesListPage){
					reportFailure("Unable to search and delete the specified job");
				}
				
				test.log(LogStatus.PASS, "Able to search and delete the specified job type");
