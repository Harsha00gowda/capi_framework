...
public class EditAutoPIValBandTest extends BaseTest{

	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void editAutoPIValBand(Hashtable<String, String> table) throws InterruptedException{
		...
		//  click on edit icon of Auto PI value band
				page = autoPIValueBandsListPage.clickOnEdit();
