...
public class DeleteAttachedContractorTest extends BaseTest {
	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void deleteAttachedContractor(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for an operative and click on delete icon
				page = contractorListPage.deleteAttachedContractor();
				if (page instanceof ContractorListPage){
					reportFailure("Unable to delete the attached contractor of a contract");
				}
				
				test.log(LogStatus.PASS, "Able to delete the attached contractor of a contract");
