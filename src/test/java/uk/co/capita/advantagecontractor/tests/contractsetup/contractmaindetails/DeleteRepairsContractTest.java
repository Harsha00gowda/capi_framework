...
public class DeleteRepairsContractTest extends BaseTest{

	public String testCaseName = this.getClass().getSimpleName(); 
	public String module = "Repairs and Contract Set Up";

	@Test(dataProvider = "getTestData")
	public void deleteRepairsContract(Hashtable<String, String> table) throws InterruptedException{
		...
		//search for a contract and click on delete icon
		page = contractListPage.searchAndDeleteContract(xls.getCellData("Repairs and Contract Set Up", "ContractName", 2));
		if (page instanceof ContractListPage){
			reportFailure("Unable to search and delete the specified contract");
		}
		
		test.log(LogStatus.PASS, "Able to search and delete the specified contract");
